...
class StarGardener(Gardener):
    ...
    def poison_pests(self):
        pests.quantity = 10
        print("The Gardener destroyed all the pests.")
...
class StarPest(Pests):

    def __init__(self, pests_type, quantity):
        super(StarPest, self).__init__(pests_type, quantity)
        self.pests_type = pests_type
        self.quantity = quantity
...
# 1. Eat the plants
    ...
    def __repr__(self):
        return f'{self.pests_type} and {self.quantity}'
